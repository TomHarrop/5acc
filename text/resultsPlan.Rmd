...
* *Which Nipponbare genes are involved in branching*?
    - **differentially expressed genes between PBM and SM in Nipponbare**
    - compare these genes to significantly differentially expressed genes from the laser microdissection dataset
* *Are there genes that are involved in branching in all species*? These genes could encode basic mechanisms
...
3. Domestication and parallel evolution
* *Which genes were under selection during the domestication of rice and parallel evolution of panicle phenotypes*?
    ...
    * consider two or three domestications: Nipponbare/IR64 vs. *rufipogon* and *glaberrima* vs. *barthii*.
    ...
    * support with genomic evidence:
        * look for variation in non-coding region of genes of interest (possible regulatory change) in these accessions
            * this essentially entails a full GWAS. Look in previous GWAS results.
        ...
        * look for DNase-seq data in rice (see citation in Swinnen 2016, which appears to be wrong, and 10.1101/gr.131342.111)
* *How has domestication and selection affected known regulators of panicle architecture*?
    * Family-wise comparisons of interesting families between the 5 accessions like in the LMD paper:
        * transcription factors
        * hormone pathways
        * cell division / cell cycle genes
