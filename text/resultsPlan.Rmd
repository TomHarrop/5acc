...
2. Basic molecular mechanisms involved in branching
    * *Are there genes that might be involved in branching in **all** species*? These could be involved in basic mechanisms
    ...
    * Divergence between African and Asian rice
        * comparison between subsets of species, e.g. potential branching genes in Asian species vs. potential branching genes in African species

3. Domestication and convergent evolution
    * *What are the genes that might have been involved in the domestication of rice and convergent evolution of panicle phenotypes*?
        * **Genes where the L2FC between PBM and SM is dependent on whether or not the species is domesticated**, e.g. there is a significant change between PBM and SM in *glaberrima* but not *barthi*
        * consider three separate domestications: Nipponbare/IR64 vs. *rufipogon* and *glaberrima* vs. *barthii*.
        * **genes from at least one asian and one african domestication: convergent evolution**
    ...
    * *How has domestication affected known regulators of panicle architecture*?
